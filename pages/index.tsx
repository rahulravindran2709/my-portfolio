    ...
    <Layout title={"Hello!"} description={""}>
      <div className="grow w-full p-4 text-white text-lg">
        <p className="">
          ...
          frontend apps since the <em>dark ages</em> ie, Internet explorer 8
          with html 4.1 with table layouts. Glad that they buried IE. Yay!
        </p>{" "}
        <br />
        <p>
          ...
          cutting edge stuff in the Ui space, all the while making sure the app
          in production runs as well as it can. I always place a strong emphasis
          on &quot;doing it right&quot; as opposed to &quot;shipping it
          quick&quot;.
        </p>
        <br />
        <p>
          Areas of frontend React expertise include but not limited to Material
          UI,Redux, Zustand. Have also extensively worked on maps using
          OpenLayers and some baby steps in Three.JS
        </p>
        <br />
        <p>
          I&apos;ve also worked on a few full stack TypeScript projects in my
          free time. Some of these were applications with separate frontend and
          an API backend. <br />
